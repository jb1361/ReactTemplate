...
import {AnyAction, applyMiddleware, combineReducers, createStore, PreloadedState} from 'redux';
...
export const configureSharedStore = <T>(appReducer: object, compose: any, middleware: any[] = [], initialState?: PreloadedState<T>, onReady?: () => void) => {
